...
export const _ColumnSelectorClause = (node) => {
  ...
  t.push(Tokens.Punctuator('('));
  t.push(...__List(node.indexedColumns, _Identifier));
  t.push(Tokens.Punctuator(')'));
...
export const DeleteStmt = (node) => {
  ...
  t.push(..._('DELETE'));
  t.push(..._('FROM'));
  t.push(...QualifiedTableName(node.qualifiedTableName));
...
export const SimpleFunctionInvocation = (node) => {
  ...
  t.push(..._Identifier(node.simpleFunc));
  t.push(Tokens.Punctuator('('));
